...
export class AppComponent implements OnInit, OnDestroy {
  configurations: QueryConfiguration[] = [
    {
      label: 'Dom i Porta do 500k, Ursynów',
      url: 'https://www.domiporta.pl/mieszkanie/sprzedam/mazowieckie/ursynow?Price.To=500000&SortingOrder=InsertionDate',
      items: [
        {
          label: 'description',
          selector: '.sneakpeak__data .sneakpeak_description',
          readMethod: 'textContent'
        },
        {
          label: 'urls',
          selector: '.sneakpeak__picture_container',
          readMethod: 'href'
        }
      ]
    },
    {
      label: 'Morizon do 500k, Ursynów',
      url: 'https://www.morizon.pl/mieszkania/najnowsze/warszawa/ursynow/?ps%5Bprice_to%5D=500000',
      items: [
        {
          label: 'titles',
          selector: '.single-result__content .single-result__title',
          readMethod: 'textContent'
        },
        {
          label: 'description',
          selector: '.single-result__content .description p',
          readMethod: 'textContent'
        },
        {
          label: 'urls',
          selector: '.single-result__content a',
          readMethod: 'href'
        }
      ]
    },
    {
      label: 'Otodom do 500k, Ursynów',
      url: 'https://www.otodom.pl/sprzedaz/mieszkanie/warszawa/ursynow/?search%5B' +
        'filter_float_price%3Ato%5D=500000&search%5Bdescription%5D=1&search%5Bdistrict_id%5D=47&search%5Bcity_id%5D=26',
      items: [
        {
          label: 'titles',
    ...
    {
      label: 'OLX do 500k, Ursynów',
      url: 'https://www.olx.pl/nieruchomosci/mieszkania/sprzedaz/warszawa/' +
        '?search%5Bfilter_float_price%3Ato%5D=500000&search%5Bdistrict_id%5D=373',
      items: [
        {
          label: 'titles',
    ...
    {
      label: 'Gumtree do 500k, Ursynów',
      url: 'https://www.gumtree.pl/s-mieszkania-i-domy-sprzedam-i-kupie/ursynow/mieszkanie/v1c9073l3200020a1dwp1?pr=,500000',
      items: [
        {
          label: 'titles',
